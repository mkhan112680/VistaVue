...
namespace VistaDM.Web.Controllers
{
    ...
    public class AccountController : BaseController
    {
        ...
        public ActionResult Login(string returnUrl)
        {
         ...
         [AllowAnonymous]
        public ActionResult LoginByUsername(LoginViewModel model)
        {
        ...
        //[AllowAnonymous]
        //[ValidateAntiForgeryToken]
        //public async Task<bool> LoginProgramatically(string userName, string pwd, string returnUrl)
        //{
        //    bool retVal = false;
        ...
        //    //var result =   SignInManager.PasswordSignIn(userName, pwd, false, shouldLockout: false);
        //    var result = await SignInManager.PasswordSignInAsync(userName, pwd, false, shouldLockout: false);
        //    switch (result)
        //    {
        //        case SignInStatus.Success:
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new VistaUser { UserName = model.Email, Email = model.Email };
