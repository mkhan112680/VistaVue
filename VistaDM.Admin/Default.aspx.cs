...
namespace VistaDM.Admin
{
    public partial class _Default : System.Web.UI.Page
    {
        ...
        private void LoadData(bool? isPCP)
        {
            ...
            this.gvCardiologists.DataSource = invRepos.GetAllInvitees(isPCP);
            this.gvCardiologists.DataBind();
        }

        private void LoadData(int provID, bool? isPCP)
        {
            this.gvCardiologists.DataSource = invRepos.GetAllInviteesByProvince(provID,isPCP);
            this.gvCardiologists.DataBind();
        }
        ...
        protected override void OnInitComplete(EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(user.Username))
            {
                ...
                {
                    if (user.TerritoryCovergae_All.HasValue && user.TerritoryCovergae_All.Value)
                    {
        ...
        protected void imgBtn_clicked(object sender, EventArgs e)
        {
            ...
            string url = string.Format("~/Reports.aspx?{0}={1}&{2}={3}&ADMIN=0", Constants.IS_PCP, (isPCP.HasValue ? isPCP.Value ? "1" : "0" : "-1"), Constants.PROVINCEID, provinceID.ToString());
        ...
        protected void gvCardiologists_HtmlDataCellPrepared(object sender, ASPxGridViewTableDataCellEventArgs e)
        {
            ...
            #region Invitations Only for PCP 

             
            ASPxCheckBox chk = gvCardiologists.FindRowCellTemplateControl(e.VisibleIndex, null, "chkCHRC") as ASPxCheckBox;
            ...
            //string docType = imgEng.Attributes["PhysicianType"].ToString();

            //if (docType == "CS")
            //{
            //    imgEng.Enabled = false;

            //    imgEng.ImageUrl = "~/images/icon_download_rollover.png";
            ...
            if ( ! chk.Checked )
            {
                ...
                imgFrench.Enabled = false;

                imgFrench.ImageUrl = "~/images/icon_download_rollover.png";
        ...
        protected void imgGenMultipleEnglish_Click(object sender, EventArgs e)
        {
            ...
            foreach (object key in keyValues)
            {
                ...
                if (doc.Invited && doc.PhysicianType != Enums.PhysicianType.CS)
                {
                    tmpList.Add(key);
                }
            }
